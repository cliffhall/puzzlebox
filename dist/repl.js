...
async function auth(provider, { serverUrl: serverUrl2, authorizationCode, scope }) {
  const metadata = await discoverOAuthMetadata(serverUrl2);
  ...
  if (!clientInformation) {
    ...
    const fullInformation = await registerClient(serverUrl2, {
      metadata,
  ...
  if (authorizationCode !== void 0) {
    ...
    const tokens2 = await exchangeAuthorization(serverUrl2, {
      metadata,
      clientInformation,
      authorizationCode,
  ...
  if (tokens === null || tokens === void 0 ? void 0 : tokens.refresh_token) {
    try {
      const newTokens = await refreshAuthorization(serverUrl2, {
        metadata,
        clientInformation,
  ...
  const { authorizationUrl, codeVerifier } = await startAuthorization(serverUrl2, {
    metadata,
    clientInformation,
...
async function discoverOAuthMetadata(serverUrl2, opts) {
  var _a2;
  const url = new URL("/.well-known/oauth-authorization-server", serverUrl2);
  let response;
  try {
...
async function startAuthorization(serverUrl2, { metadata, clientInformation, redirectUrl, scope }) {
  ...
  if (metadata) {
    ...
    authorizationUrl = new URL("/authorize", serverUrl2);
  }
...
async function exchangeAuthorization(serverUrl2, { metadata, clientInformation, authorizationCode, codeVerifier, redirectUri }) {
  ...
  if (metadata) {
    ...
    tokenUrl = new URL("/token", serverUrl2);
  }
...
async function refreshAuthorization(serverUrl2, { metadata, clientInformation, refreshToken }) {
...
async function registerClient(serverUrl2, { metadata, clientMetadata }) {
  let registrationUrl;
  if (metadata) {
    ...
    registrationUrl = new URL("/register", serverUrl2);
  }
